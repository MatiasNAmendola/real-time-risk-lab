...
description: Agregar un feature test con Cucumber-JVM para ATDD en tests/risk-engine-atdd/
---

# Sub-agent: add-feature-test-cucumber

Load and execute the skill at: `.ai/primitives/skills/add-feature-test-cucumber.md`
