...
description: Agregar un nuevo endpoint REST a controller-app respetando OpenAPI y Clean Architecture
---

# Sub-agent: add-rest-endpoint

Load and execute the skill at: `.ai/primitives/skills/add-rest-endpoint.md`
