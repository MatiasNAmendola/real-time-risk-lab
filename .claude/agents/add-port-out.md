---
name: add-port-out
description: Agregar un nuevo puerto de salida (driven port) con su adapter de infraestructura
---

# Sub-agent: add-port-out

Load and execute the skill at: `.ai/primitives/skills/add-port-out.md`
