...
description: Diagnosticar y resolver un test ATDD o unitario que falla en el CI o localmente
---

# Sub-agent: debug-failing-test

Load and execute the skill at: `.ai/primitives/skills/debug-failing-test.md`
