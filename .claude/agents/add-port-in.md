---
name: add-port-in
description: Agregar un puerto de entrada (driving port) que define el contrato del use case hacia el exterior
---

# Sub-agent: add-port-in

Load and execute the skill at: `.ai/primitives/skills/add-port-in.md`
