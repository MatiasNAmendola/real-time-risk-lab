---
name: add-fraud-rule
description: Agregar una regla deterministica al motor de decisiones de riesgo
---

# Sub-agent: add-fraud-rule

Load and execute the skill at: `.ai/primitives/skills/add-fraud-rule.md`
