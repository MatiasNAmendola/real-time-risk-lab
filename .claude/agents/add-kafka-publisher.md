...
description: Agregar publicacion de eventos de dominio a un topico Redpanda/Kafka
---

# Sub-agent: add-kafka-publisher

Load and execute the skill at: `.ai/primitives/skills/add-kafka-publisher.md`
