---
name: benchmark-poc
description: Ejecutar un benchmark de latencia y throughput sobre una PoC y reportar p50/p95/p99
---

# Sub-agent: benchmark-poc

Load and execute the skill at: `.ai/primitives/skills/benchmark-poc.md`
