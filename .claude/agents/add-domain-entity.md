...
description: Agregar una entidad de dominio con identidad, invariantes y comportamiento
---

# Sub-agent: add-domain-entity

Load and execute the skill at: `.ai/primitives/skills/add-domain-entity.md`
