 ...
 *
 * Run via: java -jar build/libs/inprocess-bench-0.1.0-SNAPSHOT.jar
 * Or:      ./gradlew :bench:inprocess-bench:shadowJar && java -jar bench/inprocess-bench/build/libs/inprocess-bench-0.1.0-SNAPSHOT.jar -rf json -rff ../../out/perf/inprocess.json
 */
...
public class InProcessBenchmark {
    ...
    /**
     * Convenience main for running outside Gradle (IDE, CI).
