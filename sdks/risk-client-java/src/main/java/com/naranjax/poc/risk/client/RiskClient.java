...
import com.naranjax.poc.risk.client.channel.ChannelClient;
...
import com.naranjax.poc.risk.client.events.EventsClient;
import com.naranjax.poc.risk.client.http.JsonHttpClient;
import com.naranjax.poc.risk.client.queue.QueueClient;
import com.naranjax.poc.risk.client.stream.StreamClient;
...
/**
 * Entry point for the NaranjaX Risk Client SDK.
 *
 * <pre>{@code
