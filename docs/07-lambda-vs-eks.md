# 07 — Lambda vs EKS: tabla comparativa y checklist de readiness
...
## 2. Tabla comparativa con criterios medibles
...
## 3. Matriz de decisión: ¿cuándo se justifica migrar?
...
## 4. Qué se gana / qué se pierde / qué se complica
...
## 5. Checklist de readiness para migrar a EKS

Antes de considerar la migración lista para producción, verificar:
