...
import io.riskplatform.riskdecision.layerpodhttp.controller.ControllerPod;
 ...
 * Deploy order: repository -> usecase -> controller on dynamic ports.
...
class EndToEndTest {
    ...
    static void setUp() throws InterruptedException {
        ...
        vertx.deployVerticle(new RepositoryPod(repositoryPort))
                ...
                .compose(__ -> vertx.deployVerticle(new ControllerPod(controllerPort, usecasePort, repositoryPort)))
