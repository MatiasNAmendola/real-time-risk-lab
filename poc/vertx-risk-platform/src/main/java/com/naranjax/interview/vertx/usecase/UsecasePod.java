package com.naranjax.interview.vertx.usecase;
...
import static com.naranjax.interview.vertx.common.PodSecurity.*;
...
public final class UsecasePod extends AbstractVerticle {
    ...
    private <T> Future<T> repo(HttpMethod method, String path, Object body, Class<T> responseType) {
        return client.request(method, 8082, "localhost", path)
