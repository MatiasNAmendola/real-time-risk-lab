package com.naranjax.distributed.repository.secrets;
 ...
 *   "naranjax/db-password" → the postgres password value
 */
public final class SecretsBootstrap {
    ...
    public static String resolveDbPassword() {
        ...
        String secretName     = System.getenv().getOrDefault("DB_SECRET_NAME", "naranjax/db-password");
        String envFallback    = System.getenv().getOrDefault("PG_PASSWORD", "naranjax");
     ...
     *   bao kv put secret/naranjax/db-password value=naranjax
     */
    private static String readFromOpenBao(String openbaoUrl, String secretName) throws Exception {
        ...
        // Normalize: "naranjax/db-password" → path component for KV v2
