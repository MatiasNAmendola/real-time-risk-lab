...
import com.naranjax.distributed.repository.secrets.SecretsBootstrap;
...
public class DbBootstrap {
    ...
    public static Future<Pool> init(Vertx vertx) {
        ...
        String database = System.getenv().getOrDefault("PG_DATABASE", "naranjax");
        String user     = System.getenv().getOrDefault("PG_USER",     "naranjax");
