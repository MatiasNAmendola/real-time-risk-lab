...
"$REPO_ROOT/gradlew" -p "$REPO_ROOT" \
  :poc:java-vertx-distributed:controller-app:shadowJar \
  :poc:java-vertx-distributed:usecase-app:shadowJar \
  :poc:java-vertx-distributed:repository-app:shadowJar \
  :poc:java-vertx-distributed:consumer-app:shadowJar
