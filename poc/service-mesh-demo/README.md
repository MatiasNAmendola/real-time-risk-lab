...
PoC dedicado para demostrar **service-to-service real** entre bounded contexts, sin confundirlo con `java-vertx-distributed`.
...
Esto contrasta con `java-vertx-distributed`, que sigue siendo **layer-as-pod**: controller/usecase/repository/consumer son capas de un mismo bounded context.
