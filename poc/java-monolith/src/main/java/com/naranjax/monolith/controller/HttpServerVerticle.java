package com.naranjax.monolith.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.naranjax.monolith.usecase.MonolithEventBusAddress;
...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        router.get("/admin/rules").handler(ctx -> {
            ...
            try {
                var loader = new com.naranjax.poc.risk.config.RulesConfigLoader();
        ...
        router.post("/admin/rules/reload").handler(ctx -> {
            ...
            } catch (com.naranjax.poc.risk.config.ConfigValidationException cve) {
