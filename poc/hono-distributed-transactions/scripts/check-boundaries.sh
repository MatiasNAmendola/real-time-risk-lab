...
APP_DOMAIN_PATHS=("src/internal/domain" "src/internal/application")
...
BOUNDARY VIOLATION:
- src/internal/domain and src/internal/application must not import Hono, Zod, BullMQ/Valkey clients,
