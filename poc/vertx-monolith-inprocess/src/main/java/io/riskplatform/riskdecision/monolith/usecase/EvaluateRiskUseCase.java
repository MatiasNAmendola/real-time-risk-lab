package io.riskplatform.riskdecision.monolith.usecase;
...
import io.riskplatform.riskdecision.monolith.repository.S3AuditPublisher;
import io.riskplatform.riskdecision.monolith.repository.SqsDecisionPublisher;
import io.riskplatform.riskdecision.monolith.repository.ValkeyIdempotencyStore;
 ...
 *
 * <p>Key architectural difference from vertx-layer-as-pod-eventbus:
 * <ul>
    ...
    private void continueEvaluation(Message<String> msg, RiskRequest req, String corrId) {
        ...
        vertx.executeBlocking(() -> featureRepository.findByCustomerId(req.customerId()))
            .onSuccess(snapshot -> {
                ...
                if (ruleEngine != null) {
                    io.riskplatform.rules.engine.FeatureSnapshot snap =
