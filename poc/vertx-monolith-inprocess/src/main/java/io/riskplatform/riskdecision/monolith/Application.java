package io.riskplatform.riskdecision.monolith;

import io.riskplatform.riskdecision.monolith.config.ApplicationFactory;
...
/**
 * Single-JVM entry point for the vertx-monolith-inprocess PoC.
 *
 ...
 *
 * <p>Architectural contrast with vertx-layer-as-pod-eventbus:
 * <ul>
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        factory.deploy()
            .onSuccess(v -> log.info("[vertx-monolith-inprocess] All verticles deployed — ready on port 8090"))
            .onFailure(err -> {
                log.error("[vertx-monolith-inprocess] Startup failed: {}", err.getMessage(), err);
                vertx.close();
                System.exit(1);
            });
    }
