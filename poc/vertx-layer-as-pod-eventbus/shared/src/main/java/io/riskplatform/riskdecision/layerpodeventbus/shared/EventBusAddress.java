package io.riskplatform.riskdecision.layerpodeventbus.shared;
...
public final class EventBusAddress {
    ...
    /** controller-app → usecase-app: readiness probe that does not mutate state */
    public static final String USECASE_READY = "usecase.ready";

    /** usecase-app → repository-app: readiness probe that does not mutate state */
    public static final String REPOSITORY_READY = "repository.ready";
