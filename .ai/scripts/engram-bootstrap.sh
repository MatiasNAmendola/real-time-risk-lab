...
echo "     mem_search(query: \"naranjax poc <poc-name>\")"
echo ""
...
echo "  naranjax/interview-prep/state"
echo "  naranjax/poc/java-risk-engine"
echo "  naranjax/poc/java-vertx-distributed"
echo "  naranjax/poc/vertx-risk-platform"
echo "  naranjax/poc/k8s-local"
echo "  naranjax/primitives/system"
echo ""
