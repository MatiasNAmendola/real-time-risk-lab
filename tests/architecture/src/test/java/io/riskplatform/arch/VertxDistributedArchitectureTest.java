 ...
 *
 * These tests import compiled class files from each module's build/classes/java/main.
...
class VertxDistributedArchitectureTest {
    ...
    static void importClasses() {
        ...
        assumeTrue(!presentDirs.isEmpty(),
            ...
            "compile the PoC first: ./gradlew :tests:architecture:test");
