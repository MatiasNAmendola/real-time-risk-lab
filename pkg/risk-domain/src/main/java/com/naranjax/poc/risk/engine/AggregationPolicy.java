...
import com.naranjax.poc.risk.rule.AllowlistOverrideable;
...
public final class AggregationPolicy {
    ...
    public RuleAction aggregate(List<RuleEvaluation> results,
                                List<com.naranjax.poc.risk.rule.FraudRule> compiledRules,
        ...
        for (int i = 0; i < results.size(); i++) {
            ...
            if (eval.triggered() && i < compiledRules.size()) {
                com.naranjax.poc.risk.rule.FraudRule rule = compiledRules.get(i);
